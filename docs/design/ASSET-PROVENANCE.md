...
`public/assets/rain-portrait.png`（1024×1536）、`darkroom.png` 和 `rain-wide.png`（均 1672×941）于 2026-09-22 使用 Image Gen 为本项目生成。

人物为虚构成年摄影爱好者，后两张沿用首张人物视觉参考。采用已批准 UI 中的雨夜城市与琥珀色暗房方向；不是下载的电影剧照，不代表人物一致性的模型实测结果。
